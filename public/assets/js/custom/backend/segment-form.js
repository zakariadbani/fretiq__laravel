...
var KTSegmentForm = function () {
    ...
    var SEL = {
        ...
        engagementCampaignId:   'select[name="filter[engagement][campaign_id][]"]',
        engagementOpened:       'select[name="filter[engagement][opened]"]',
        engagementClicked:      'select[name="filter[engagement][clicked]"]',
        engagementSansDemande:  'input[name="filter[engagement][sans_demande]"]',
    ...
    function collectPayload() {
        ...
        return {
            ...
            filter: {
                ...
                engagement: {
                    campaign_id:  $(SEL.engagementCampaignId).val() || [],
                    opened:       $(SEL.engagementOpened).val() || '',
                    clicked:      $(SEL.engagementClicked).val() || '',
                    sans_demande: $(SEL.engagementSansDemande).is(':checked') ? 1 : 0,
                },
            },
        };
    }
    ...
    function bindEvents() {
        ...
        $(SEL.engagementCampaignId).on('change', refreshPreview);
        $(SEL.engagementOpened).on('change', refreshPreview);
        $(SEL.engagementClicked).on('change', refreshPreview);
        $(SEL.engagementSansDemande).on('change', refreshPreview);
    }
