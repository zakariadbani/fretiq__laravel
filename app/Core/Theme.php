...
class Theme
{
    ...
    {
        return sprintf(
            '<link rel="icon" type="image/svg+xml" href="%s" /><link rel="alternate icon" href="%s" />',
            asset('assets/media/logos/favicon.svg'),
            asset(config('settings.KT_THEME_ASSETS.favicon'))
        );
    }
