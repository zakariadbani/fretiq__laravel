{{--
    Thin shim: Segment hero + tab nav.
    ...
    Usage: @include('backend.contents.segments.partials._header-with-tabs', [
        'model'       => $model,
...
@php
    ...
    $config = $viewConfig ?? \App\Crud\ViewConfigs\SegmentViewConfig::make($model, $stats ?? null);
@endphp
...
@include('backend.partials.crud._tabbar', [
    ...
    'config'      => $config,
    'actions'     => $__env->make('backend.contents.segments.partials._header-actions', [
                         'model'  => $model,
                         'isView' => $isView,
