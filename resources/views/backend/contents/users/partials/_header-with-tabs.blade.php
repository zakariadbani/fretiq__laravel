{{--
    ...
    Usage: @include('backend.contents.users.partials._header-with-tabs', [
        'model'       => $model,
...
@php
    ...
    $config = $viewConfig ?? \App\Crud\ViewConfigs\UserViewConfig::make($model);
@endphp
...
@include('backend.partials.crud._tabbar', [
    ...
    'config'      => $config,
    'actions'     => $__env->make('backend.contents.users.partials._header-actions', [
                         'model'  => $model,
                         'isView' => $isView,
