{{--
    Thin shim: Sequence hero + tab nav.
    ...
    Usage: @include('backend.contents.sequences.partials._header-with-tabs', [
        'model'       => $model,
...
@php
    ...
    $config = $viewConfig ?? \App\Crud\ViewConfigs\SequenceViewConfig::make($model);
@endphp
...
@include('backend.partials.crud._tabbar', [
    ...
    'config'      => $config,
    'actions'     => $__env->make('backend.contents.sequences.partials._header-actions', [
                         'model'  => $model,
                         'isView' => $isView,
