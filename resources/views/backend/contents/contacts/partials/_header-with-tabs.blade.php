{{--
    Thin shim: Contact hero + tab nav.
    ...
    Usage: @include('backend.contents.contacts.partials._header-with-tabs', [
        'model'       => $model,
...
@php
    ...
    $config = $viewConfig ?? \App\Crud\ViewConfigs\ContactViewConfig::make($model);
@endphp
...
@include('backend.partials.crud._tabbar', [
    ...
    'config'      => $config,
    'actions'     => $__env->make('backend.contents.contacts.partials._header-actions', [
                         'model'  => $model,
                         'isView' => $isView,
