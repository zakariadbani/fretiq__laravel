{{--
    Thin shim: Demande hero + tab nav.
    ...
    Usage: @include('backend.contents.demandes.partials._header-with-tabs', [
        'model'       => $model,
...
@php
    ...
    $config = $viewConfig ?? \App\Crud\ViewConfigs\DemandeViewConfig::make($model);
@endphp
...
@include('backend.partials.crud._tabbar', [
    ...
    'config'      => $config,
    'actions'     => $__env->make('backend.contents.demandes.partials._header-actions', [
                         'model'  => $model,
                         'isView' => $isView,
