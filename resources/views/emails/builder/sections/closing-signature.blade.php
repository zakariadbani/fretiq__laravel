...
<tr>
  <td class="pad-mobile" style="padding:16px 30px 32px 30px;background-color:#ffffff;">
    <p class="body-text" style="margin:0 0 20px 0;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#333333;">{{ $slots['closing_line'] ?? $copy['closing_fallback'] }}</p>
    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#002e71;font-weight:bold;">{{ $copy['regards'] }}<br>{{ $copy['team'] }}</p>
  </td>
</tr>
