...
<tr>
  <td class="mobile-pad" style="padding:48px 44px 42px;background-color:#002e71;">
    <p style="margin:0 0 14px;font-size:14px;line-height:20px;color:#f5b51d;font-weight:bold;text-transform:uppercase;letter-spacing:1px;">Votre fret, notre priorité</p>
    ...
    <p style="margin:0 0 14px;font-size:17px;line-height:27px;color:#dce9f8;">Bonjour @{{contact.first_name}},</p>
