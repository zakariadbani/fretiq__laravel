...
<tr>
  <td class="pad-mobile" style="padding:8px 30px 24px 30px;background-color:#ffffff;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #dddddd;background-color:#f7f9fc;">
      <tr>
        <td width="50%" style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;color:#ffffff;font-weight:bold;background-color:#0548a5;border-bottom:1px solid #dddddd;">Origine</td>
        <td width="50%" style="padding:12px 16px;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;color:#ffffff;font-weight:bold;background-color:#0548a5;border-bottom:1px solid #dddddd;">Fréquence</td>
      </tr>
